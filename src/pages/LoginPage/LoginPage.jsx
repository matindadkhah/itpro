...
export default function LoginPage() {
    ...
    return (
        <div className="flex h-screen w-full bg-gradient-to-br from-gray-100 to-gray-200 font-shabnam " dir="rtl">
                ...
                <div className="w-full max-w-sm">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-2 rounded-lg text-white font-semibold shadow-md transition-all ${loading
